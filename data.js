...
btnDaily.onclick = () =>{
    ...
    fetch("data.json")   /* a changer */
    .then(reponse => reponse.json())
    .then(reponse2 => {
    
        currentWork.textContent = reponse2.array[0].timeframes.daily.current;
        previousWork.textContent = reponse2.array[0].timeframes.daily.previous;
